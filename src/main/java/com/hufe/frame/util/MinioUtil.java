...
public class MinioUtil {
  ...
  public void putObject(String bucketName, String objectName, InputStream stream, long size) throws Exception {
    ...
    String contentType = Optional.ofNullable(ContentInfoUtil.findExtensionMatch(suffix))
  ...
  public void moveObject(String bucketName, String targetObjectName, String sourceObjectName) throws Exception {
    Iterable<Result<Item>> results = client.listObjects(
      ListObjectsArgs.builder().bucket(bucketName).prefix(sourceObjectName).recursive(true).build());
    ...
    while (iterator.hasNext()) {
      ...
      client.copyObject(
        CopyObjectArgs.builder()
          .bucket(bucketName)
          .object(objectName.replace(sourceObjectName, targetObjectName))
   ...
   * @throws Exception https://docs.minio.io/cn/java-client-apireference.html#removeObject
   */
  public void batchRemoveObject(String bucketName, String dirName) throws Exception {
    Iterable<Result<Item>> results = client.listObjects(
      ListObjectsArgs.builder().bucket(bucketName).prefix(dirName).recursive(true).build());
    Iterator<Result<Item>> iterator = results.iterator();
    while (iterator.hasNext()) {
      Result<Item> item = iterator.next();
      String objectName = item.get().objectName();
